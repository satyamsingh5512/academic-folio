...
interface FooterProps {
    ...
    socialLinks?: Array<{
        href: string;
        label: string;
        icon: "github" | "linkedin" | "email" | "google_scholar" | "twitter" | "instagram";
    }>;
}

export default function Footer({
    desc = "Blog on ML, AI & other acronyms. All opinions are my own.",
    name = "Satyam Singh",
    year = new Date().getFullYear(),
    socialLinks = [
        { href: "https://www.linkedin.com/in/kozodoi/", label: "LinkedIn", icon: "linkedin" },
        { href: "https://github.com/kozodoi", label: "GitHub", icon: "github" },
        { href: "https://scholar.google.com/citations?user=58tMuD0AAAAJ&hl=en", label: "Google Scholar", icon: "google_scholar" },
        { href: "https://twitter.com/n_kozodoi", label: "Twitter", icon: "twitter" },
        { href: "https://www.instagram.com/n_kozodoi/", label: "Instagram", icon: "instagram" },
    ],
}: FooterProps) {
    return (
            ...
            <div className="container-narrow">
                <div className="flex flex-col items-center justify-center text-center gap-6">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-12 items-center justify-center w-full">
                        {/* Description */}
                        <div className="text-[var(--color-text-muted)] max-w-md">
                            <p>{desc}</p>
                        </div>
                    ...
                    {socialLinks.length > 0 && (
                        <nav aria-label="Social links" className="flex flex-wrap justify-center gap-6 mt-2">
...
function SocialIcon({ type }: { type: "github" | "linkedin" | "email" | "google_scholar" | "twitter" | "instagram" }) {
